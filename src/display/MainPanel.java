		...
		while (it.hasNext()) {
			...
			if (obj.getVisible()) {
				...
				if (obj instanceof DragArea) {
					g.drawRect((int) obj.getBaseLocation().getX(), (int) obj.getBaseLocation().getY(),
							(int) obj.getRect().getWidth(), (int) obj.getRect().getHeight());
				} else {
					g.drawOval((int) obj.getBaseLocation().getX(), (int) obj.getBaseLocation().getY(),
							(int) obj.getRect().getWidth(), (int) obj.getRect().getHeight());
				}
				String text = "";
				...
				// text = "";
				g.drawString(text, (int) obj.getBaseLocation().getX(), (int) obj.getBaseLocation().getY());
			}
		}
	}
}
